...
$meta_boxes[] = array(
	...
	'fields' => array(
		/*array(
			'name' => 'Layout',
			'desc' => 'How many columns post will have',
			'id' => $prefix . 'columns',
			'type' => 'select', // select box
			'options' => array('Default (1 column)', 'Double (2 columns)', 'Triple (3 columns)', 'Insane (4 columns)') // array of options for select box
		),
		array(
			'name' => 'Box Size',
			...
			'id' => $prefix . 'box_size',
			'type' => 'select', // select box
			'options' => array('Default (310px)', 'Tiny (150px)', 'Medium (485px)', 'Large (660px)') // array of options for select box
		),
		array(
			'name' => 'Display Title?',
		...
		array(
			'name' => 'Display Featured Image on top of post?', // check box
			'desc' => 'The featured image will be displayed in all locations (besides the single post page), even if you have a video embed code set.',
			'id' => $prefix . 'featimg',
			'type' => 'checkbox'
		),*/
		array(
			'name' => 'Estonian post url:',
			'desc' => "Place link to original post here.",
			'id' => $prefix . 'estlink',
			'type' => 'textarea', // text area
		),
		array(
			'name' => 'Russian post url:',
			'desc' => "Place link to translatet post here.",
			'id' => $prefix . 'rulink',
			'type' => 'textarea', // text area
		),
	)
