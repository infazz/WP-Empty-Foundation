...
$meta_boxes[] = array(
	...
	'only_on'    => array(
		...
		'template' => array( 'templates/page-contact.php' ),
		//'parent'   => array( 10 )
	),
);
...
$meta_boxes[] = array(
	'title' => __( 'Текст после карты', 'meta-box' ),
	'pages' => array( 'page' ),
	'context' => 'normal',
	'priority' => 'high',
	'autosave' => true,
...
$meta_boxes[] = array(
	'title' => __( 'Текст благорадности', 'meta-box' ),
	'pages' => array( 'page' ),
	'context' => 'normal',
	'priority' => 'high',
	'autosave' => true,
	...
	'only_on'    => array(
		//'id'       => array( 1, 2 ),
		// 'slug'  => array( 'news', 'blog' ),
		'template' => array( 'templates/page-guru.php' ),
		//'parent'   => array( 10 )
	),
);
/**
