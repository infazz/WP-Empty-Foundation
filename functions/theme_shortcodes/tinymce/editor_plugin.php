...
$plugin_url = get_template_directory_uri().'/functions/theme_shortcodes/tinymce/';
?>
(function(){
			...
			init: function(d,e) {
					...
					d.addCommand( "myThemeOpenDialog",function(a,c){
						...
						jQuery.get(e+"/dialog.php",function(b){
							...
							switch ( myThemeSelectedShortcodeType ) {
								...
								var a = '[extrawrap]'+selectedText+'[/extrawrap]';
				...
				createControl:function(d,e){
                  ...
                  c=b.addMenu({title:"HTML"});
										...
										a.addWithDialog(c,"Year Box","year");
										a.addWithDialog(c,"Extra Wrap Box","extrawrap");
